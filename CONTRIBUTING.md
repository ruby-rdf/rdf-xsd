...
* create or respond to an issue for on the [Github Repository](http://github.com/ruby-rdf/rdf-xsd/issues)
* Fork and clone the repo:
  `git clone git@github.com:your-username/rdf-xsd.git`
* Install bundle:
  `bundle install`
...
[pr]:      https://github.com/ruby-rdf/rdf-xsd/compare/
